...
export default function Newsletter() {
  ...
  return (
    <section
      id="pem-section"
      className="px-4 pt-16 md:pt-20 lg:pt-24"
      style={{ scrollMarginTop: "80px" }}
    >
      <div className="bg-[#3F5F56] rounded-3xl p-8 md:p-16 text-center max-w-5xl mx-auto shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            Enter your email to access your free PEM Wheel and take the first
            honest look.
          </p>
