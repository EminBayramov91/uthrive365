...
export default function Navbar() {
  ...
  return (
    <header
      className="sticky top-0 w-full z-50 transition-all duration-300 bg-[#EEF3F1]/98 backdrop-blur-[10px] border-b border-black/[0.08] shadow-[0_8px_24px_rgba(0,0,0,0.06)] py-3.5 md:py-[18px]"
    >
