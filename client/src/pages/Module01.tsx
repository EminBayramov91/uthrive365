      ...
      <article className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="mt-16 pt-12 border-t border-border">
          <div className="space-y-6 text-center">
            ...
            <Link
              href="/#pem-section"
              className="inline-flex items-center justify-center px-8 py-4 bg-primary text-primary-foreground font-bold rounded-xl hover:bg-primary/90 transition-colors"
            >
